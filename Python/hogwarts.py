...
students = ["Hermoine", "Harry", "Ron"] #closed barackets indicates a list
...
print (students["Hermoine"]) #Instead of using numbers to call entries as seen in lists, we can use words here to get what said word is associated with
