...
public class PriorityQueueTimer {
    ...
    public static void main(String[] args) 
    {
		...
		PriorityQueueInt binaryHeapPQ = new BinaryHeap();
		PriorityQueueInt threeHeapPQ = new ThreeHeap();
		PriorityQueueInt MyPQPQ = new MyPQ();
		
		PriorityQueueInt[] queueArray = {binaryHeapPQ, threeHeapPQ, MyPQPQ};
		String[] queueNames = {"BinaryHeap", "ThreeHeap", "MyPQ"};
		Map<String, PriorityQueueInt> queueMap = new HashMap<>();
   ...
   public static void timeRun(PriorityQueueInt pQueue, double[] testData) 
   {
